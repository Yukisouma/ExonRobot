...
def send_help(chat_id, text, keyboard=None):
    ...
    if not keyboard:
        ...
        # kb.append([InlineKeyboardButton(text='sᴜᴘᴘᴏʀᴛ', url='https://t.me/maki_supportchat'),
...
def help_button(update: Update, context: CallbackContext):
    ...
    try:
        if mod_match:
            ...
            # kb.append([InlineKeyboardButton(text='Support', url='https://t.me/maki_updates'),
...
━━━━━━━━━━━━━
⍟ ᴍʏ [ᴏᴡɴᴇʀ](https://t.me/Yuki_hun_bhai)
